...
<div class="content">
    <h2 class="text-center">Active <span class="text-success">Services</span></h2>
        ...
        <div class="col-md-4">
            <div class="card promotion-card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <a href="{{ route('service.edit', $promotion) }}" class="btn btn-success btn-block">Edit Offer</a>
                        </div>
                        <div class="col-md-6">
                            <form action="{{ route('service.destroy', $promotion) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this promotion?');">
                                @csrf
                                @method('DELETE')
